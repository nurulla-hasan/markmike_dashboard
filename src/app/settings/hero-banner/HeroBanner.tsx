    ...
    <PageLayout>
      ...
      <Tabs defaultValue="landing" className="space-y-6">
        ...
        <TabsContent value="landing">
          <BannerGrid banners={DUMMY_BANNERS.landing} />
        </TabsContent>
        <TabsContent value="deals">
          <BannerGrid banners={DUMMY_BANNERS.deals} />
        </TabsContent>
        <TabsContent value="standout">
          <BannerGrid banners={DUMMY_BANNERS.standout} />
        </TabsContent>
      </Tabs>
    </PageLayout>
  );
...
const BannerGrid = ({ banners }: { banners: any[] }) => {
  if (banners.length === 0) {
    return (
