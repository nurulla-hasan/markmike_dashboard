      ...
      <FormField
        ...
        render={() => (
          <FormItem>
            ...
            <FormControl>
              <div className="flex aspect-square w-full flex-col items-center justify-center rounded-lg border-2 border-dashed border-muted-foreground/25 bg-muted/50 text-muted-foreground transition-colors hover:bg-muted">
                <Camera className="h-10 w-10 mb-2 opacity-50" />
                <span className="text-sm">Upload Product Thumbnail image</span>
              </div>
            </FormControl>
            <FormMessage />
          </FormItem>
